...
CREATE TABLE `avatar`  (
  ...
  CONSTRAINT `avatar_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `coderhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of avatar
-- ----------------------------
INSERT INTO `avatar` VALUES (1, '82fa920b1d18eb7eafcef196f8ff8a8f', 'image/jpeg', 58305, 1, '2023-11-16 15:22:44', '2023-11-16 15:22:44');
INSERT INTO `avatar` VALUES (2, '76dfeb4be84c12b4be43fb76d98d12d3', 'image/jpeg', 39193, 2, '2023-11-16 16:03:56', '2023-11-16 16:03:56');
...
CREATE TABLE `coderhub_users`  (
  ...
  `createAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updateAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `avatar_url` varchar(200) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `coderhub_users` VALUES (1, '7ong', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-08 09:16:02', '2023-11-17 09:43:48', 'http://127.0.0.1:8000/users/1/avatar');
INSERT INTO `coderhub_users` VALUES (2, 'james', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-08 15:15:54', '2023-11-16 16:03:56', 'http://127.0.0.1:8000/users/2/avatar');
INSERT INTO `coderhub_users` VALUES (3, 'kobe', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-08 15:41:13', '2023-11-08 15:41:13', NULL);
INSERT INTO `coderhub_users` VALUES (4, 'lili', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-08 15:42:38', '2023-11-08 15:42:38', NULL);
INSERT INTO `coderhub_users` VALUES (5, 'jack', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-09 19:56:44', '2023-11-09 19:56:44', NULL);
INSERT INTO `coderhub_users` VALUES (6, 'xiaoli', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-09 19:56:53', '2023-11-09 19:56:53', NULL);
INSERT INTO `coderhub_users` VALUES (7, 'junjun', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-09 19:57:01', '2023-11-09 19:57:01', NULL);
INSERT INTO `coderhub_users` VALUES (8, 'xx', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-10 16:23:13', '2023-11-10 16:23:13', NULL);
INSERT INTO `coderhub_users` VALUES (9, '7', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-10 16:58:52', '2023-11-10 16:58:52', NULL);
INSERT INTO `coderhub_users` VALUES (10, 'long', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-10 17:03:18', '2023-11-10 17:03:18', NULL);
INSERT INTO `coderhub_users` VALUES (11, 'cc', '397a79aca9daa9aa6b06dfd834e23c81', '2023-11-11 12:16:04', '2023-11-11 12:16:04', NULL);
INSERT INTO `coderhub_users` VALUES (12, 'admin', '848488f7ea1e5d0fe67bc0c3f6d2dd60', '2023-11-17 09:41:54', '2023-11-17 09:41:54', NULL);
...
CREATE TABLE `comment`  (
  ...
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `coderhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (8, '学习前端最重要的是Html+Css+JavaScript', 2, 8, NULL, '2023-11-13 11:38:55', '2023-11-13 11:38:55');
INSERT INTO `comment` VALUES (9, '文学创作实在是太精彩了', 9, 1, NULL, '2023-11-15 15:33:40', '2023-11-15 15:33:40');
...
CREATE TABLE `file`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `moment_id`(`moment_id`) USING BTREE,
  CONSTRAINT `file_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `coderhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Records of file
-- ----------------------------
INSERT INTO `file` VALUES (5, '9d1f64df9080644864b3400f4aa056ef', 'image/png', 79899, 2, 2, '2023-11-16 17:33:42', '2023-11-16 17:33:42');
INSERT INTO `file` VALUES (6, '3956b8cd3540c7fc26086c873ec25810', 'image/png', 53022, 2, 2, '2023-11-16 17:33:42', '2023-11-16 17:33:42');
INSERT INTO `file` VALUES (7, '035415614ce550b9e59c87ddb299a00b', 'image/png', 79899, 2, 2, '2023-11-16 19:05:52', '2023-11-16 19:05:52');
INSERT INTO `file` VALUES (8, 'd7d061812b2d1d0b5420d501308fed0b', 'image/png', 53022, 2, 2, '2023-11-16 19:05:52', '2023-11-16 19:05:52');
INSERT INTO `file` VALUES (9, 'a512808eb8fcaca6d9aaf631a3737a95', 'image/png', 79899, 2, 2, '2023-11-16 20:01:34', '2023-11-16 20:01:34');
INSERT INTO `file` VALUES (10, 'd0462343502b339480c2fa52e877507b', 'image/png', 53022, 2, 2, '2023-11-16 20:01:34', '2023-11-16 20:01:34');
INSERT INTO `file` VALUES (11, 'ab72e1523d02b183c989462f0246ff8d', 'image/png', 79899, 2, 1, '2023-11-16 20:04:13', '2023-11-16 20:04:13');
INSERT INTO `file` VALUES (12, 'e8840bd9e3ae7624a5df27c1504a0225', 'image/png', 53022, 2, 1, '2023-11-16 20:04:13', '2023-11-16 20:04:13');
...
-- Records of label
-- ----------------------------
INSERT INTO `label` VALUES (1, '感悟', '2023-11-14 18:49:44', '2023-11-14 18:49:44');
INSERT INTO `label` VALUES (2, '杂谈', '2023-11-14 18:49:44', '2023-11-14 18:49:44');
INSERT INTO `label` VALUES (3, '读书', '2023-11-14 18:49:44', '2023-11-14 18:49:44');
INSERT INTO `label` VALUES (4, 'java', '2023-11-14 18:50:16', '2023-11-14 18:50:16');
INSERT INTO `label` VALUES (5, 'go', '2023-11-14 18:51:02', '2023-11-14 18:51:02');
INSERT INTO `label` VALUES (6, 'PHP', '2023-11-14 18:51:02', '2023-11-14 18:51:02');
INSERT INTO `label` VALUES (7, '后端', '2023-11-14 18:51:49', '2023-11-14 18:51:49');
INSERT INTO `label` VALUES (8, '前端', '2023-11-14 18:51:49', '2023-11-14 18:51:49');
INSERT INTO `label` VALUES (9, '开发', '2023-11-14 18:52:53', '2023-11-14 18:52:53');
INSERT INTO `label` VALUES (10, 'python', '2023-11-14 18:52:53', '2023-11-14 18:52:53');
INSERT INTO `label` VALUES (11, 'HTML', '2023-11-14 18:56:12', '2023-11-14 18:56:12');
INSERT INTO `label` VALUES (12, 'CSS', '2023-11-14 18:56:12', '2023-11-14 18:56:12');
INSERT INTO `label` VALUES (13, 'vue', '2023-11-14 18:57:21', '2023-11-14 18:57:21');
INSERT INTO `label` VALUES (14, 'react', '2023-11-14 18:57:21', '2023-11-14 18:57:21');
INSERT INTO `label` VALUES (15, 'JavaScript', '2023-11-14 18:57:54', '2023-11-14 18:57:54');
INSERT INTO `label` VALUES (16, 'Next', '2023-11-14 18:57:54', '2023-11-14 18:57:54');
INSERT INTO `label` VALUES (17, 'SpringBoot', '2023-11-14 19:00:22', '2023-11-14 19:00:22');
INSERT INTO `label` VALUES (18, '爱情', '2023-11-15 08:58:04', '2023-11-15 08:58:04');
INSERT INTO `label` VALUES (19, '文学', '2023-11-15 08:58:04', '2023-11-15 08:58:04');
INSERT INTO `label` VALUES (20, '古文', '2023-11-15 10:43:27', '2023-11-15 10:43:27');
INSERT INTO `label` VALUES (21, '历史', '2023-11-15 10:43:27', '2023-11-15 10:43:27');
...
CREATE TABLE `moment`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `moment_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `coderhub_users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of moment
-- ----------------------------
INSERT INTO `moment` VALUES (2, '玲珑骰子安红豆，入骨相思知不知', 1, '2023-11-09 19:55:25', '2023-11-09 19:55:25');
INSERT INTO `moment` VALUES (3, '封装测试权限中间件之后修改内容测试1', 2, '2023-11-09 19:55:25', '2023-11-10 15:58:49');
INSERT INTO `moment` VALUES (4, '如此生活30年，直到大厦崩塌', 3, '2023-11-09 19:55:26', '2023-11-09 19:55:26');
INSERT INTO `moment` VALUES (5, '秋阴不散霜飞晚，留得枯荷听雨声', 4, '2023-11-09 19:55:26', '2023-11-09 19:55:26');
INSERT INTO `moment` VALUES (7, '玲珑骰子安红豆，入骨相思知不知', 1, '2023-11-09 19:55:54', '2023-11-09 19:55:54');
INSERT INTO `moment` VALUES (8, '我想要说的，前人们都说过了', 2, '2023-11-09 19:55:54', '2023-11-09 19:55:54');
INSERT INTO `moment` VALUES (9, '如此生活30年，直到大厦崩塌', 3, '2023-11-09 19:55:54', '2023-11-09 19:55:54');
INSERT INTO `moment` VALUES (10, '秋阴不散霜飞晚，留得枯荷听雨声', 4, '2023-11-09 19:55:54', '2023-11-09 19:55:54');
INSERT INTO `moment` VALUES (12, '玲珑骰子安红豆，入骨相思知不知', 1, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (13, '我想要说的，前人们都说过了', 2, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (14, '如此生活30年，直到大厦崩塌', 3, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (15, '秋阴不散霜飞晚，留得枯荷听雨声', 4, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (16, '最是人间留不住，朱颜辞镜花辞树', 6, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (17, '天欲使其灭亡，必先使其疯狂。 --佚名', 3, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (18, '缺月挂疏桐，漏断人初静。 --卜算子', 4, '2023-11-09 19:57:20', '2023-11-09 19:57:20');
INSERT INTO `moment` VALUES (34, '封装测试权限中间件之后修改内容测试1', 8, '2023-11-10 17:01:02', '2023-11-10 17:01:12');
INSERT INTO `moment` VALUES (35, 'xx首次动态信息1', 8, '2023-11-11 12:09:13', '2023-11-11 12:09:13');
INSERT INTO `moment` VALUES (39, 'xx动态信息1', 8, '2023-11-14 15:26:17', '2023-11-14 15:26:17');
...
-- ----------------------------
INSERT INTO `moment_label` VALUES (2, 18, '2023-11-15 08:58:04', '2023-11-15 08:58:04');
INSERT INTO `moment_label` VALUES (2, 19, '2023-11-15 08:58:04', '2023-11-15 08:58:04');
INSERT INTO `moment_label` VALUES (7, 20, '2023-11-15 10:43:27', '2023-11-15 10:43:27');
INSERT INTO `moment_label` VALUES (7, 21, '2023-11-15 10:43:27', '2023-11-15 10:43:27');
